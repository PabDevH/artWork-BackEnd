...
$location['subSection']="Gold Collections";
...
<body class="animsition">
    <div class="page-wrapper">
        ...
        <div class="page-content--bgf7">
            ...
            <!-- LIST-->
            <?php require("includes/sections/goldCollectionsList.php"); ?>
            <!-- END LIST-->
    ...
    <script>
        ...
        const reloadGoldCollections = async ()  => {
            if (window.ethereum) {
                accounts = await getAccounts();
                tipper_addresses = accounts;
            }
            isAllowanceOnGold();
            getGoldCollectionsDetail();
        }
        window.ethereum.on('accountsChanged',reloadGoldCollections);
    </script>
